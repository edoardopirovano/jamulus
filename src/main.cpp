...
int main ( int argc, char** argv )
{
    ...
    for ( int i = 1; i < argc; i++ )
    {
        ...
        {
            bIsClient = false;
            tsConsole << "- server mode chosen" << Qt::endl;
        ...
        {
            bUseGUI = false;
            tsConsole << "- no GUI mode chosen" << Qt::endl;
                               ...
                               "--licence" ) )
        {
            ...
            tsConsole << "- licence required" << Qt::endl;
                               ...
                               "--fastupdate" ) )
        {
            ...
            tsConsole << "- using " << SYSTEM_FRAME_SIZE_SAMPLES << " samples frame size mode" << Qt::endl;
                               ...
                               "--multithreading" ) )
        {
            ...
            tsConsole << "- using multithreading" << Qt::endl;
                               ...
                               "--startminimized" ) )
        {
            ...
            tsConsole << "- start minimized enabled" << Qt::endl;
                               ...
                               "--discononquit" ) )
        {
            ...
            tsConsole << "- disconnect all clients on quit" << Qt::endl;
                               ...
                               "--nojackconnect" ) )
        {
            ...
            tsConsole << "- disable auto Jack connections" << Qt::endl;
                               ...
                               "--notranslation" ) )
        {
            ...
            tsConsole << "- translations disabled" << Qt::endl;
                               ...
                               "--showallservers" ) )
        {
            ...
            tsConsole << "- show all registered servers in server list" << Qt::endl;
                               ...
                               "--showanalyzerconsole" ) )
        {
            ...
            tsConsole << "- show analyzer console" << Qt::endl;
                                  ...
                                  rDbleArgument ) )
        {
            ...
            tsConsole << "- selected controller MIDI channel: " << iCtrlMIDIChannel << Qt::endl;
                                 ...
                                 strArgument ) )
        {
            ...
            tsConsole << "- logging file name: " << strLoggingFileName << Qt::endl;
                                  ...
                                  rDbleArgument ) )
        {
            ...
            tsConsole << "- selected port number: " << iPortNumber << Qt::endl;
                                 ...
                                 strArgument ) )
        {
            ...
            tsConsole << "- HTML status file name: " << strHTMLStatusFileName << Qt::endl;
                                 ...
                                 strArgument ) )
        {
            ...
            tsConsole << "- client name: " << strClientName << Qt::endl;
                                 ...
                                 strArgument ) )
        {
            ...
            tsConsole << "- recording directory name: " << strRecordingDirName << Qt::endl;
                               ...
                               "--norecord" ) )
        {
            ...
            tsConsole << "- recording will not be enabled" << Qt::endl;
                                 ...
                                 strArgument ) )
        {
            ...
            tsConsole << "- central server: " << strCentralServer << Qt::endl;
                                 ...
                                 strArgument ) )
        {
            ...
            tsConsole << "- server info: " << strServerInfo << Qt::endl;
                                 ...
                                 strArgument ) )
        {
            ...
            tsConsole << "- server list filter: " << strServerListFilter << Qt::endl;
                                 ...
                                 strArgument ) )
        {
            ...
            tsConsole << "- welcome message: " << strWelcomeMessage << Qt::endl;
                                 ...
                                 strArgument ) )
        {
            ...
            tsConsole << "- initialization file name: " << strIniFileName << Qt::endl;
                                 ...
                                 strArgument ) )
        {
            ...
            tsConsole << "- connect on startup to address: " << strConnOnStartupAddress << Qt::endl;
        ...
        {
            bMuteStream = true;
            tsConsole << "- mute stream activated" << Qt::endl;
                               ...
                               "--mutemyown" ) )
        {
            ...
            tsConsole << "- mute me in my personal mix" << Qt::endl;
        ...
        if ( ( !strcmp ( argv[i], "--version" ) ) ||
             ( !strcmp ( argv[i], "-v" ) ) )
        {
            tsConsole << GetVersionAndNameStr ( false ) << Qt::endl;
            exit ( 1 );
        }
        ...
        tsConsole << "Unknown option '" <<
            argv[i] << "' -- use '--help' for help" << Qt::endl;
...
// is called with weird command line args -> do not exit on these
    ...
    {
        bUseGUI = false;
        tsConsole << "No GUI support compiled. Running in headless mode." << Qt::endl;
    }
    ...
    {
        tsConsole << "No initialization file support in headless server mode." << Qt::endl;
    }
    ...
    if ( bIsClient && bUseGUI && bMuteMeInPersonalMix )
    {
        ...
        tsConsole << "Mute my own signal in my personal mix is only supported in headless mode." << Qt::endl;
    }
...
#endif
        {
            tsConsole << generr.GetErrorText() << Qt::endl;
        }
    }
                         ...
                         QString&     strArg )
{
         ...
         ( !strLongOpt.compare ( argv[i] ) ) )
    {
        ...
        {
            tsConsole << argv[0] << ": ";
            tsConsole << "'" << strLongOpt << "' needs a string argument" << Qt::endl;
            exit ( 1 );
        }
         ...
         ( !strLongOpt.compare ( argv[i] ) ) )
    {
        if ( ++i >= argc )
        {
            ...
            tsConsole << "'" <<
                ...
                rRangeStart << " and " << rRangeStop << Qt::endl;
